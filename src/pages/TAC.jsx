  ...
  return (
    <section className="mt-[-0.5m] bg-gradient-to-r from-customColor-dark-magenta to-customColor-dark-blue ">
      ...
      <div className="max-w-screen-xl px-4 py-4  mx-auto space-y-4 lg:space-y-6 lg:py-24 lg:px-6 text-left text-gray-300">
        <h1 className="mt-20 md:mt-0 text-xl lg:text-3xl font-extrabold text-white">Terms & Condition</h1>
        <p className="mt-20 lg:mt-10">
          These terms and conditions outline the rules and regulations for the
          use of AR filters offered by Think Again Lab, located at
          https://getyourfilter.thinkagainlab.com/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use getyourfilter if you do not agree
        ...
        <h3 class="text-md lg:text-2xl font-extrabold text-white">
          <strong>Cookies</strong>
        </h3>

        <p>
          We employ the use of cookies. By accessing getyourfilter, you agreed
          to use cookies in agreement with the Think Again Lab's Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Think Again Lab and/or its licensors own the
          intellectual property rights for all material on getyourfilter. All
          intellectual property rights are reserved. You may access this from
          getyourfilter for your own personal use subjected to restrictions set
        ...
        <ul>
          <li>Republish material from getyourfilter</li>

          <li>Sell, rent or sub-license material from getyourfilter</li>

          <li>Reproduce, duplicate or copy material from getyourfilter</li>

          <li>Redistribute content from getyourfilter</li>
        </ul>
        ...
        <p>
          ...
          Think Again Lab does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Think Again Lab,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their
          views and opinions. To the extent permitted by applicable laws, Think
          Again Lab shall not be liable for the Comments or for any liability,
        ...
        <p>
          Think Again Lab reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Think Again Lab a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Think Again Lab; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Think Again Lab. Please include your name, your
        ...
        <p>
          No use of Think Again Lab's logo or other artwork will be allowed for
